...
settings = Dynaconf(
    ...
    settings_files=['settings.toml', "secrets/.secrets.toml", f'secrets/.secrets.{os.getenv("ENV_FOR_DYNACONF")}.toml'], # supports any order (the later files can override earlier ones).
)
